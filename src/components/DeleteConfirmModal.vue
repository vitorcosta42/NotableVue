<template>
  <div class="flex flex-col my-auto bg-white w-2/3">
    ...
    <footer class="text-right">
      <button class="border border-gray-200 px-3 py-2 rounded-2xl mr-4
      hover:bg-gray-200">Cancelar</button>
      <button class="border border-gray-200 px-3 py-2 rounded-2xl bg-red-400 text-white
      hover:bg-red-500">Excluir</button>
    </footer>
  </div>
